...
### Full-Stack Software Engineer specializing in React/TypeScript, Node.js, and LLM Integration. 
I build production-grade web applications, robust local AI proxies, and automated data pipelines from scratch to deployment.
...
* **Browser-Side Tech:** Chrome Extensions (MV3), Tampermonkey Userscripts, Network Interception (Fetch/XHR proxying), Iframe Sandboxing.
* **Data Processing:** Binary data manipulation (PNG tEXt injection, CRC32), stream-wrapping (SSE), automated JSONL conversion for RAG training.
